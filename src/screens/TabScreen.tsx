...
function SocialScreen() {
  return (
     <View className="flex flex-1 items-center justify-center pt-16">
       <Text>Social</Text>
    </View>
  );
}
    ...
    <View style={{ flexDirection: "row" }}>
      {state.routes.map((route, index:number) => {
        ...
        return (
            ...
            >
              {route.name === "Home" ? (
                <View className={classNames( isFocused 
                  ? "bg-main-red/20"
                  : "bg-transparent",
                  "items-center justify-center rounded-2xl px-2 py-1"
                  )}> 
                <Wine className={classNames( isFocused 
                  ? "text-main-red"
                  : "text-main-gray",
                  "w-8 h-8"
                  )}
                ...
                <Users  className={classNames( isFocused 
                  ? "text-main-red"
                  : "text-main-gray",
                  "w-8 h-8"
                  )}
                ...
                <Bell className={classNames( isFocused 
                  ? "text-main-red"
                  : "text-main-gray",
                  "w-8 h-8"
                  )}
